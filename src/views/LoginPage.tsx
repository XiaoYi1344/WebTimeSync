...
export default function LoginPage() {
  ...
  const handleTextLogin = async (
    ...
    try {
      ...
      /*
       * Không expose chi tiết backend.
       *
       * Dùng message thống nhất:
       */
  ...
  const handleFaceScan = () => {
     ...
     * TODO:
     *
     * Thay phần setTimeout này
     * bằng API Face Recognition thật.
     */
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        /*
         * Face authentication thật
         * cần backend trả employee/role.
         *
         * Hiện tại giữ route employee.
         */
        ...
        <div className="relative z-10 w-full max-w-lg">
          ...
          >
            ...
            <p className="text-lg text-neutral-400 mb-10 max-w-md leading-relaxed">
              ...
              AI tích hợp Camera thực tế. Nhận diện
              chuẩn xác, nhanh chóng và an toàn.
            </p>
            ...
            {loginMode === "face" && (
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-neutral-400">
                    Nhìn thẳng vào Camera để đăng nhập
                    vào hệ thống
                  </p>
