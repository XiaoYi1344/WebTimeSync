...
// type FaceRecord = (typeof faceRegistrations)[number];
...
// type ModalMode = "register" | "update" | null;
...
//   const [faceList, setFaceList] =
//     useState<FaceRecord[]>(faceRegistrations);

//   const [modalMode, setModalMode] =
//     useState<ModalMode>(null);

//   const [selectedRecord, setSelectedRecord] =
//     useState<FaceRecord | null>(null);
...
//   if (!form.deviceId) {
//     alert("Vui lòng chọn thiết bị lấy mẫu.");
//     return;
//   }

//   if (!form.imageUrl) {
//     alert(
//       "Vui lòng chụp hoặc tải ảnh khuôn mặt."
//     );
//     return;
//   }
...
//     const newRecord: FaceRegistration = {
//       id: `face-${Date.now()}`,
...
//     setFaceList((prev) => {
//       // Một nhân viên chỉ có một Face ID
//       const withoutOldRecord = prev.filter(
//         (record) =>
//           record.employeeId !==
//           form.employeeId
//       );
...
//           // Giữ nguyên người đăng ký ban đầu
//           registeredAt:
//             record.registeredAt ??
//             now,
...
//     `Bạn có chắc muốn xóa dữ liệu Face ID của ${
...
//                           <span className="min-w-[34px] text-sm font-semibold text-slate-700">
//                             {Math.round(
//                               record.confidence *
//                                 100
//                             )}
...
//   "
//   title="Xóa Face ID"
//   aria-label={`Xóa Face ID của ${record.employee.fullName}`}
// >
...
//                     Chọn nhân viên và lấy mẫu khuôn
//                     mặt để hệ thống nhận diện.
//                   </p>
//                 </div>
//               </div>
...
//                         <div className="absolute left-3 top-3 flex items-center gap-1.5 rounded-full border border-emerald-100 bg-white/95 px-3 py-1.5 text-xs font-semibold text-emerald-600 shadow-sm backdrop-blur">
...
//                     Khuyến nghị ảnh rõ mặt, đủ ánh sáng,
//                     không đeo khẩu trang hoặc che khuất
//                     khuôn mặt. Tối đa 5MB.
//                   </p>
//                 </div>
...
//                         AI sẽ xử lý dữ liệu sau khi lưu
//                       </div>

//                       <p className="mt-1 text-[11px] leading-5 text-slate-400">
//                         Hệ thống sẽ trích xuất
//                         embedding khuôn mặt và gắn
//                         dữ liệu nhận diện với nhân viên
//                         đã chọn. Độ chính xác thực tế
//                         sẽ được trả về từ AI backend.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
